...
<html>
	...
	<body>
		<h2>USER : <%=currentUser%>'s SENT MESSAGES</h2>
		<table style="width:100%">
			...
			%>
				...
				<%
					...
					sql = "SELECT * FROM msgInfo WHERE del is null AND sender = ? ORDER BY CAST(msgID AS int) DESC";
				...
				%>
						<tr>
							...
							<!-- Subject -->
							<td>
								<a href="showSentMsg.jsp?msgID=<%=rs.getString("msgID")%>&user=<%=currentUser%>"><%=rs.getString("subject")%></a>
							</td>
							<!-- Date -->
