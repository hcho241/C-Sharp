<!-- Insert what user reply as a msg -->
...
<html>
	...
	<body>
		...
		%>
			...
			<%
				// First, find max num then increment by 1 to avoid duplicate when user delete msg
				...
				if (rs.next()){
					...
					if (rs.next()){
						...
						// writer == currentUser 
						sql = "INSERT INTO msgInfo(msgID, subject, date, sender, message, receiver) VALUES(?, '[RE:]'+?, ?, ?, ?, ?)";
						pstmt = conn.prepareStatement(sql);	
