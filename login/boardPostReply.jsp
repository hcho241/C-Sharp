<!-- Insert what user reply a post in the board in boardDB-->
			...
			<%
				...
				if (rs.next()){
					...
					if (rs.next()){
						...
						// writer == currentUser 
						sql = "INSERT INTO boardInfo(num, title, writer, date, contents, views) VALUES(?, '[RE:]'+?, ?, ?, ?, 0)";
						pstmt = conn.prepareStatement(sql);	
						pstmt.setString(1, num);
						pstmt.setString(2, reTitle); 	
